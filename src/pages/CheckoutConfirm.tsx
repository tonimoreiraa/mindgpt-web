...
{
    return <div className="bg-green-500 px-8 h-screen w-screen flex items-center justify-center text-white">
        <div className="max-w-[24rem] flex items-center justify-center text-center flex-col">
            ...
            <h2 className="text-base font-light">O pagamento foi confirmado e agora você tem acesso ilimitado ao MindGPT.<br/> Descubra o potêncial da IA agora mesmo:</h2>
